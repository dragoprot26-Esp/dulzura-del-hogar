/* Service Worker — Dulzura del Hogar (PWA instalable + shell offline) */
const CACHE = 'dulzura-v1';
const SHELL = ['./', './index.html', './admin.html', './manifest.json', './img/icon-192.png', './img/icon-512.png'];
